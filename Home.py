...
st.markdown("""
    ...
    #### User Manual
    To understand how to use the TB Outcomes Oracle in details, please read the [TB Outcomes Oracle User Manual](https://drive.google.com/file/d/13Q-lUBe5uA9yyu1syBOolFjgnlo-OoKq/view?usp=sharing).
